...
use gadget_sdk::network::{
    self, IdentifierInfo, Network, NetworkMultiplexer, StreamKey, SubNetwork,
};
    ...
    M: serde::de::DeserializeOwned,
{
    ...
    pub fn new(network: N, i: PartyIndex, parties: BTreeMap<PartyIndex, ecdsa::Public>) -> Self {
    ...
    M: round_based::ProtocolMessage,
{
    ...
    fn poll_flush(self: Pin<&mut Self>, cx: &mut Context) -> Poll<Result<(), Self::Error>> {
        ...
        while let Some(out) = this.outgoing_queue.pop_front() {
            ...
            let key = StreamKey {
                // TODO: Set the correct task hash from the network.
                task_hash: [0u8; 32],
